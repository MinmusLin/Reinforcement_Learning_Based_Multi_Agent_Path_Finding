...
def animate(trainer, env):
    ...
    ani = FuncAnimation(fig, update, frames=len(all_steps), interval=500, blit=True, repeat=False)

    plt.tight_layout()
    plt.show()

    ani.save('animate_results/GreedyTrajectoriesDQNObstacle.gif', writer='pillow', fps=2, dpi=100)
